...
export const metadata: Metadata = {
  title: 'Mubashir Ahmad | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Mubashir Ahmad! Built using TypeScript, Next.js 14, Framer Motion and Tailwind CSS.',
};
